                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nombre del empleado" class="form-control text-upper">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apellidoPaterno" value="<?php echo e(old('apellidoPaterno')); ?>" placeholder="Apellido paterno" class="form-control text-upper">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apellidoMaterno" value="<?php echo e(old('apellidoMaterno')); ?>" placeholder="Apellido materno" class="form-control text-upper">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <div class="text-black h4">
                                            <?php echo Form::radio('roles[]', $role->id, null, ['class' => 'mr-1']); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" value="<?php echo e(old('username')); ?>" placeholder="Nombre del usuario" class="form-control text-upper">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" value="<?php echo e(old('password')); ?>" placeholder="contraseña" class="form-control text-upper">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="conf_password" value="<?php echo e(old('conf_password')); ?>" placeholder="contraseña" class="form-control text-upper">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sistema\resources\views/usuarios/create.blade.php ENDPATH**/ ?>