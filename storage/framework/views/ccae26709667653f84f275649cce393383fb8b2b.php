...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <select name="" id="selectorMarca" class="form-control form-select">
                                     ...
                                     <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="tamanio" value="<?php echo e(old('stock')); ?>"
                                                        placeholder="" class="form-control text-upper" min="1">
                                        </div>
                                     </div>
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="voltaje" value="<?php echo e(old('stock')); ?>"
                                                        placeholder="" class="form-control text-upper" min="1">
                                        </div>
                                     </div>
                                    ...
                                    <div class="col-md-8 mt-2">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control text-upper"
                                                placeholder="" name="descripcion"><?php echo e(old('descripcion')); ?></textarea>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sistema\resources\views/productos/baterias_add.blade.php ENDPATH**/ ?>