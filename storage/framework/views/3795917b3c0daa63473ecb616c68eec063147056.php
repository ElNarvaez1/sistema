                            ...
                            <table class="table  table-light mt-2" width="100%" cellspacing="0">
                                ...
                                <tbody class="text-black2">
                                    ...
                                    <tr class="table-hover">
                                        ...
                                        <td>
                                            <a title="editar producto" href="<?php echo e(route('llantas.edit', $producto->idLlanta)); ?>" class="btn btn-outline-primary btn-circle">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sistema/resources/views/productos/llantas/llantas_index.blade.php ENDPATH**/ ?>