                                                                            ...
                                                                            <div class="col-md-12 mt-4">
                                                                                    ...
                                                                                    <label class="text-black"><FONT SIZE =3>Fecha en la que se esta realizando la devolución:</FONT></label>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input disabled="true" value="<?php echo e($venta->idVenta); ?>" type="text" required>
                                                                                        </div>
                                                                                        
                                                                                        <div class="form-group">
                                                                                            <label class="text-black"><FONT SIZE =3>Motivo de la devolución:</FONT></label>
                                                                                            <textarea class="form-control" value="<?php echo e(old('message')); ?>" name="descripcion" placeholder="ejemp. Producto en mal estado" required></textarea>
                                                                                        </div>                                                                                       
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sistema/resources/views/devoluciones/confirmar_devolucion.blade.php ENDPATH**/ ?>