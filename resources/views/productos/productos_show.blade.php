                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-auto ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled="true" value="{{ $producto->nombre }}" placeholder="Introduce el nombre del producto" class="form-control" name="nombre" required value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mt-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="number" disabled="true" value="{{ $producto->stock }}" placeholder="En existencia" class="form-control" name="stock">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8 mt-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" disabled="true" name="descripcion">{{ $producto->descripcion }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled="true" value="{{ $producto->precio_c }}" placeholder="Introduce precio del producto 0.0 $" class="form-control" name="precio" required value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled="true" value="{{ $producto->precio_v }}" placeholder="Introduce precio del producto 0.0 $" class="form-control" name="precio" required value="">
                                    </div>
                                </div>
