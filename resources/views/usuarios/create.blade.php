                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Nombre del empleado" class="form-control text-upper">
                                        {{-- validaciones --}}
                                        @error('name')
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apellidoPaterno" value="{{ old('apellidoPaterno') }}" placeholder="Apellido paterno" class="form-control text-upper">
                                        {{-- validaciones --}}
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apellidoMaterno" value="{{ old('apellidoMaterno') }}" placeholder="Apellido materno" class="form-control text-upper">
                                        {{-- validaciones --}}
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" value="{{ old('username') }}" placeholder="Nombre del usuario" class="form-control text-upper">
                                        {{-- validaciones --}}
                                        @error('username')
                                        <div class="message-error">*{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" value="{{ old('password') }}" placeholder="contraseña" class="form-control text-upper">
                                        {{-- validaciones --}}
                                        @error('password')
                                        <div class="message-error">*{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="conf_password" value="{{ old('conf_password') }}" placeholder="contraseña" class="form-control text-upper">
                                        {{-- validaciones --}}
                                        @error('conf_password')
                                        <div class="message-error">*{{ $message }}</div>
                                        @enderror
