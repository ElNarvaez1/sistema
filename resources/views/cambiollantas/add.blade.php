                                                        ...
                                                        <div class="container px-5 my-5">
                                                            <div class="row">
                                                                <div class="right-content">
                                                                    <div class="container">
                                                                        <form id="formularioCambioLLantas" > <!--action="{{ route('promocion.send')}}" method="post" enctype="multipart/form-data"-->
                                                                            {{ csrf_field() }}
                                                                            <div class="row">
                                                                            ...
                                                                            <div class="col-md-12 mt-4">
                                                                                ...
                                                                                <a class="btn btn-outline-success" href="{{ route('clientes.create') }}">Revisar historial</a>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
